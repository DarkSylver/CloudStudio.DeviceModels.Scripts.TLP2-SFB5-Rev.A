function parseUplink(device, payload) {
    ...
    env.log("Decoded messages: " + JSON.stringify(decodedMessages));

    if (!decodedMessages || decodedMessages.length === 0) {
        env.log("ERROR: decodedMessages is empty or undefined.");
        return;
    }
    ...
    if (!decodedMessage) {
        env.log("ERROR: decodedMessage is undefined.");
        return;
    }

    env.log("Decoded message: " + JSON.stringify(decodedMessage));

    // Geolocation
    if (decodedMessage.latlngValid && decodedMessage.latitude != null && decodedMessage.longitude != null && decodedMessage.altitude != null) {
        var eplt = device.endpoints.byAddress("1");
        if (eplt != null) {
            eplt.updateLocationTrackerStatus(decodedMessage.latitude, decodedMessage.longitude, decodedMessage.altitude, 0);
        }
    }

    // Altitude
    if (decodedMessage.latlngValid && decodedMessage.altitude != null) {
        var epa = device.endpoints.byAddress("2");
        if (epa != null) {
            epa.updateGenericSensorStatus(decodedMessage.altitude);
        }
    }

    // Device Temperature
    if (decodedMessage.deviceTemp != null) {
        var eplt = device.endpoints.byAddress("3");
        if (eplt != null) {
            eplt.updateTemperatureSensorStatus(decodedMessage.deviceTemp);
        }
    }

    // Device Light Sensor
    if (decodedMessage.lightSensor != null) {
        var eplt = device.endpoints.byAddress("4");
        if (eplt != null) {
            eplt.updateLightSensorStatus(decodedMessage.lightSensor);
        }
    }

    // Device Battery Voltage
    if (decodedMessage.batteryVoltage != null) {
        var e = device.endpoints.byAddress("5");
        if (e != null) {
            e.updateVoltageSensorStatus(decodedMessage.batteryVoltage);
        }
    }

    // Device Battery Percentage
    if (decodedMessage.batteryCharge != null) {
    ...
    if (decodedMessage.solarVoltage != null) {
        var e = device.endpoints.byAddress("7");
        if (e != null) {
            e.updateVoltageSensorStatus(decodedMessage.solarVoltage);
        }
    }

    // Device Speed
    if (decodedMessage.speed != null) {
        var e = device.endpoints.byAddress("8");
        if (e != null) {
            e.updateGenericSensorStatus(decodedMessage.speed);
        }
    }
    ...
    if (decodedMessage.bleDataList != null && Array.isArray(decodedMessage.bleDataList)) {
        for (var i = 0; i < decodedMessage.bleDataList.length; i++) {
            ...
            if (ble && ble.mac === "d18f98c1c589" && ble.temp != null) {
            ...
            if (ble && ble.mac === "d18f98c1c589" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "d18f98c1c589" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "d18f98c1c589" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "d18f98c1c589" && ble.rssi != null) {
            ...
            if (ble && ble.mac === "c94a49ccfa91" && ble.temp != null) {
            ...
            if (ble && ble.mac === "c94a49ccfa91" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "c94a49ccfa91" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "c94a49ccfa91" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "c94a49ccfa91" && ble.rssi != null) {
